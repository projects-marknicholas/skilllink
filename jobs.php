...
<head>
  ...
  <title> Skill Link | Job Listings </title>
...
<body onload="logoBeat()" style="font-family: 'Sora', sans-serif;">
  ...
  <!-- Main Container -->
  <div class="container-fluid" style=" background-color: #00FE75; background-position: center; background-size: cover; background-repeat: no-repeat; background-attachment: fixed;">
    ...
    <div class="hero" style=" color:whitesmoke; height: 1700px;">
      ...
      <div style="width: 100%" class="row">
        <div class="col-md-9">
          ...
          <h1 id="jbs" style="color: #FE0089;">Find jobs</h1>
            <form class="example" action="jobs.php">
              ...
              <button type="submit" style="height:45px; width:160px; border-radius:0px 30px 30px 0px; background-color: #FE0089; "><i class="fa fa-search bb"></i></button>
            </form>
          </div>
          ...
          <div class="container" style="padding-left:50px; padding-top:50px; padding-bottom:50px;">
            ...
            ?>
                <h3 style="font-family: 'Schoolbell', cursive; font-family: 'Vollkorn', serif; color: #FE0089; padding-left:4px;"> Total Job Posts Available: <?php echo $numberofposts; ?> </h3>
            <?php }
            } ?>
            ...
            ?>
                <h3 style="font-family: 'Schoolbell', cursive; font-family: 'Vollkorn', serif; color: #FE0089; padding-left:4px;"> Active Users: <?php echo $numberofusers; ?> </h3>
            <?php }
            } ?>
            <!--------------------------------------------------------------------------------------------->
            ...
            <div class="row">
              ...
              ?>
                  ...
                  <div class="col-md-4 crd" style="margin: 20px; background-color:#FE0089; padding: 20px;">

                    <h3 style="color: #00FE75"> <b> <?php echo $jobtitle; ?> <b> </h3>
                    <!-- ------------------------------------------------------------------ -->
                    <h5 style="color:#00FE75">By <?php echo $ename; ?> </h5> <br>
                    <!-- ------------------------------------------------------------------ -->
                    <h5> <b style="color:#00FE75">Job Description:</b> <br> </h5>
                    <h5><?php echo $desc; ?></h5>
                    <!-- ------------------------------------------------------------------ -->
                    <h5><b style="color:#00FE75">Experience Required:</b>
                      <?php echo $minexp; ?> years </h5>
                    <!-- ------------------------------------------------------------------ -->
                    <h5><b style="color:#00FE75">Salary:</b>
                      <?php echo $salary; ?> </h5> <br>
                    <!-- ------------------------------------------------------------------ -->
                    <a href="applyJob.php?id=<?php echo $pid; ?>" class="pull-right" style="font-family: 'Sora', sans-serif; color:#00FE75;">
        ...
        <div style=" height: 100vh; " class="col-md-3">
          ...
          <h3 style="color: #FE0089;">Jobs By Category</h3>
            <form>
          ...
          <br><br>
          <div style="padding-top:10px; padding-right:30px;">
          <h3 style="color: #FE0089;">Jobs By Industry</h3>
